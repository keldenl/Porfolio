...
We're DONE! Click [here](http://www.openprocessing.org/sketch/166582) for the online demo. Links to download all the files have two options, [Processing + Executable](../downloads/GameOfLife/GameOfLife_EXE.zip) or just the [Zipped .Pde file](../downloads/GameOfLife/GameOfLife.zip). Copy the [full code](../downloads/GameOfLife/GameOfLife.pde) for the lazy.
